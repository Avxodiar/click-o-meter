...
@section('content')
    <div class="container">
        <div class="m-5">
            ...
            <ul>
                <li>
                    <a href="{{ route('test1') }}">Пример сайта с имплементированным скриптом</a>
                </li>
                <li>
                    <a href="{{ route('graph') }}">Просмотр карты кликов в админке</a>
                </li>
            </ul>
            ...
            <p><a href="{{ route('map') }}">График распределения кликов по времени суток</a></p>
